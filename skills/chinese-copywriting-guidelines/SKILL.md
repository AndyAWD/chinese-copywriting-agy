...
這份 skill 讓 Antigravity 全系列產品（包含 Antigravity CLI `agy`、Antigravity IDE、Antigravity 2.0 Desktop）在撰寫或校對中文文件時，自動遵守 [sparanoid/chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines) 的排版規範。核心目的是讓混合中文、英文、數字的內容讀起來更清爽、更專業。
